const NavBarComponent = () => {
    return(
        <div 
            className="fixed bg-black-100/90 text-white w-full h-[5rem]
            ...
            <div className="flex items-center justify-end gap-8 w-5/6">
                <form className="flex items-center sm:max-w-full max-w-12 grow justify-end">
                    <input type="text" className="rounded-full h-12 md:min-w-64 md:max-w-[500px] min-w-12 w-full text-black-100 px-4 sm:placeholder-current placeholder-transparent sm:placeholder-gray-400" placeholder='music...' />
                ...
                <div className="font-supakan hidden sm:block">Melody<span className="text-pinky-500">Flow</span></div>
            </div>
        </div>
    )
}
